...
- test_execute_as_user_role_matrix_allows_privileged_roles_and_denies_user — [backend/tests/misc/auth/test_as_user_impersonation.rs](backend/tests/misc/auth/test_as_user_impersonation.rs)
- test_self_execute_as_runs_under_actor_user_id_for_dml_and_select — [backend/tests/misc/auth/test_as_user_impersonation.rs](backend/tests/misc/auth/test_as_user_impersonation.rs)
- test_allowed_execute_as_can_select_update_and_delete_target_rows — [backend/tests/misc/auth/test_as_user_impersonation.rs](backend/tests/misc/auth/test_as_user_impersonation.rs)
- test_disallowed_execute_as_denial_is_audited — [backend/tests/misc/auth/test_as_user_impersonation.rs](backend/tests/misc/auth/test_as_user_impersonation.rs)
- test_execute_as_shared_table_is_denied_after_role_authorization — [backend/tests/misc/auth/test_as_user_impersonation.rs](backend/tests/misc/auth/test_as_user_impersonation.rs)
- test_execute_as_nonexistent_user_is_error — [backend/tests/misc/auth/test_as_user_impersonation.rs](backend/tests/misc/auth/test_as_user_impersonation.rs)
...
- test_service_role_user_table_reads_are_subject_scoped — [backend/tests/misc/auth/test_rbac.rs](backend/tests/misc/auth/test_rbac.rs#L55)
