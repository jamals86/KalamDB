...
fn create_fdw_routine() -> *mut pg_sys::FdwRoutine {
    unsafe {
        ...
        (*routine_ptr).AddForeignUpdateTargets =
            Some(crate::fdw_modify::add_foreign_update_targets);
        ...
        (*routine_ptr).GetForeignModifyBatchSize =
            Some(crate::fdw_modify::get_foreign_modify_batch_size);
