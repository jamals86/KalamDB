...
impl NamespacesTableProvider {
    ...
    pub fn create_namespace(&self, namespace: Namespace) -> Result<(), KalamDbError> {
        self.store.put(&namespace.namespace_id, &namespace)?;
        Ok(())
    }

    /// Alias for create_namespace (for backward compatibility)
    pub fn insert_namespace(&self, namespace: Namespace) -> Result<(), KalamDbError> {
    ...
    pub fn update_namespace(&self, namespace: Namespace) -> Result<(), KalamDbError> {
    ...
    pub fn delete_namespace(&self, namespace_id: &NamespaceId) -> Result<(), KalamDbError> {
        self.store.delete(namespace_id)?;
        Ok(())
    }

    /// List all namespaces
    pub fn list_namespaces(&self) -> Result<Vec<Namespace>, KalamDbError> {
