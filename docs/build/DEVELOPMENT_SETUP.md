...
```bash
# Check Rust version (should be 1.75 or later)
rustc --version
...
2. Review the [Architecture Documentation](../specs/001-build-a-rust/) to understand KalamDB's design
3. Check out the [API Documentation](../backend/README.md#api-endpoints) for REST endpoints
