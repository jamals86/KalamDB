...
async fn test_datatypes_preservation_values() {
    ...
    // Use Timestamp (no tz) for now to align with current builder; DateTime (tz) can be added once tz-aware arrays are constructed
    ColumnDefinition::simple("dt", 10, KalamDataType::Timestamp),
        ...
        ColumnDefinition::simple("_updated", 15, KalamDataType::Timestamp),
        ColumnDefinition::simple("_deleted", 16, KalamDataType::Boolean),
    ];
