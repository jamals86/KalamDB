...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_673: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_676: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3478: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3478_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3478_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3477: (a: number, b: number) => void;
