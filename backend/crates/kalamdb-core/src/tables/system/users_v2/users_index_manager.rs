...
impl UserIndexManager {
    ...
    pub fn get_by_username(&self, username: &str) -> Result<Option<UserId>, KalamDbError> {
    ...
    pub fn get_by_role(&self, role: &Role) -> Result<Vec<UserId>, KalamDbError> {
    ...
    ) -> Result<Vec<UserId>, KalamDbError> {
