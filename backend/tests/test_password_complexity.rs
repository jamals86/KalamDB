...
async fn setup_executor(enforce_complexity: bool) -> (SqlExecutor, Arc<AppContext>, Arc<datafusion::prelude::SessionContext>) {
    ...
    let executor = SqlExecutor::new(app_context.clone(), enforce_complexity);
