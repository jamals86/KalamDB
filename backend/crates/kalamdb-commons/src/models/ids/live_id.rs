...
use crate::models::{ConnectionId, UserId, TableId};
...
impl LiveId {
    pub fn new(
        ...
        Self { connection_id, table_id, query_id: query_id.into() }
    }
    ...
    pub fn from_string(s: &str) -> Result<Self, String> {
        ...
        // Parse table_id from namespace:table format
        let table_id = TableId::from_storage_key(parts[2].as_bytes())
