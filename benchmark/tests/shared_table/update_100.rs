...
#[test]
fn shared_table_update_100() -> anyhow::Result<()> {
    ...
    for i in 1..=100 {
        let update_sql = format!(
            "UPDATE bench_shared.items SET value = 'updated_value_{}' WHERE value = 'benchmark_value_{}'",
            i, i
        );
    ...
    let mut result = TestResult::new(
        ...
        "update",
        "Update 100 rows in shared table",
    );
